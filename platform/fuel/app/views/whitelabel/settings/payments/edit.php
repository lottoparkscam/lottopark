            ...
            <div class="col-md-6">
                <form method="post" autocomplete="off" action="<?= $urls["add_edit"]; ?>">
                    ...
                    <div class="form-group <?= $error_class["method"]; ?>">
                        ...
                        <select required name="input[method]"
                    ...
                    <div class="form-group <?= $error_class["cost_percent"]; ?>">
                        ...
                        <p class="help-block">
                            <?php
                                echo _(
                                "E.g. 4 if this payment method's company charge "
                                    . "you 4%. Use dot for decimal digits. Not required."
                            );
                            ?>
                        </p>
                    </div>
                    ...
                    ?>
                            ...
                            <div class="form-group <?= $error_class["min_purchase_by_currency"]; ?>">
                                <label class="control-label" for="inputMinPurchaseByCurrency">
                                    <?= _("Minimum purchase in default currency"); ?>:
                                </label>
                                <div class="input-group">
                    ...
                    <?php if (!Helpers_Whitelabel::is_V1($whitelabel['type'])): ?>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"
