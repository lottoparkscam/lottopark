...
class Double_Jack_Keno_Integration extends Seeder
{
    use \Without_Foreign_Key_Checks,
        \Adjusts_Next_Draw_Date;

    const LOTTERY_ID = Helpers_Lottery::DOUBLE_JACK_KENO_ID;
    const LOTTERY_SOURCE_ID = 45;
    const LOTTERY_TYPE_ID = 39;
    const LOTTERY_PROVIDER_ID = 49;
        ...
        return [
            'lottery' => [
                [
                    ...
                    'name' => 'DoubleJack Keno',
                    'shortname' => 'DJK',
                    'country' => 'World',
                    'country_iso' => 'FR',
                    'slug' => 'double-jack-keno',
                    'is_enabled' => 0,
                    'timezone' => $timezone,
                    ...
                    'last_update' => Carbon::now()->format(Helpers_Time::DATE_FORMAT),
                    'price' => 1.00,
                    'estimated_updated' => 0,
