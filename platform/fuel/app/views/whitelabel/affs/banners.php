...
<div class="container-fluid">
    ...
    <div class="col-md-10 banners-generator">
        <div class="container-fluid container-admin row">
            <div class="col-md-12">
                <h2><?= _("Banners"); ?></h2>
                <p class="help-block"><?= _("Here you can get your banner code."); ?></p>
            </div>
            <div class="col-md-6">
                <?php
                ...
                <form method="post" action="">
                    <div class="form-group">
                        ...
                        <select name="lottery" id="banner_lottery" class="form-control">
                            <?php
                                ...
                                ?>
                                    <option value="<?= $lottery['slug']; ?>"<?= Input::post("lottery") == $lottery['slug'] ? ' selected="selected"' : ''; ?>><?= Security::htmlentities($lottery['name']); ?></option>
                            <?php
                                endforeach;
                            ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="language" id="banner_lang" class="form-control">
                            <?php
                                foreach ($langs as $lang):
                            ?>
                                    <option value="<?= $lang['code'];?>"<?php if ((Input::post("language") !== null && Input::post("language") == $lang['code']) || (Input::post("language") === null && $whitelabel['language_id'] == $lang['id'])): echo ' selected="selected"'; endif; ?>><?= Security::htmlentities(Lotto_View::format_language($lang['code'])); ?></option>
                            <?php
                                endforeach;
                            ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="banner_size" id="banner_size" class="form-control">
                            ...
                            ?>
                                    <option value="<?= $key; ?>"<?= Input::post("banner_size") == $key ? ' selected="selected"' : ''; ?>><?= Security::htmlentities($size); ?></option>
                            <?php
                                endforeach;
                            ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="color_type" id="color_type" class="form-control">
                            ...
                            ?>
                                    <option value="<?= $type; ?>"<?= Input::post("color_type") == $type ? ' selected="selected"' : ''; ?>><?= _($color); ?></option>
                            <?php
                                endforeach;
                            ?>
                            <option value="" id="lottery_color"<?= (Input::post("color_type") !== null && Input::post("color_type") == "") ? ' selected="selected"' : ''; ?>><?= _('Lottery colors'); ?></option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="medium">
