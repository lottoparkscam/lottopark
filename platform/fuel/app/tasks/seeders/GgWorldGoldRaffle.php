...
final class GgWorldGoldRaffle extends Seeder
{
    use \Without_Foreign_Key_Checks;

    const RAFFLE_ID = 16;
    const RAFFLE_RULE_ID = 16;
    const RAFFLE_PROVIDER_ID = 16;
    const SLUG = Raffle::GG_WORLD_GOLD_RAFFLE_SLUG;
    const NAME = 'GG World Gold Raffle';
