...
final class GgWorldPlatinumRaffle extends Seeder
{
    use \Without_Foreign_Key_Checks;

    const RAFFLE_ID = 17;
    const RAFFLE_RULE_ID = 17;
    const RAFFLE_PROVIDER_ID = 17;
    const SLUG = Raffle::GG_WORLD_PLATINUM_RAFFLE_SLUG;
    const NAME = 'GG World Platinum Raffle';
    const COUNTRY_NAME = 'World';
    const COUNTRY_ISO = null;
    const TIMEZONE = 'UTC';
    const JACKPOT = 50000;
    const TICKET_PRICE = 45;
    const TICKET_COUNT = 2500;
    const CURRENCY = Currency::EUR;
    const MAX_LINES_PER_TICKET = 2500;
        ...
        return [
            ...
            'raffle_rule_tier' => [
                ...
                [
                    'raffle_rule_id' => self::RAFFLE_RULE_ID,
                    'currency_id' => self::CURRENCY,
                    'slug' => 'raffle-closed:4_8',
                    'matches' => json_encode([[4, 8]]),
                    'prize_type' => 0,
                    'prize_fund_percent' => 2,
                    'odds' => 500,
                    'prize' => 250,
                    'is_main_prize' => 0,
                ],
                [
                    'raffle_rule_id' => self::RAFFLE_RULE_ID,
                    'currency_id' => self::CURRENCY,
                    'slug' => 'raffle-closed:9_33',
                    'matches' => json_encode([[9, 33]]),
                    'prize_type' => 0,
                    'prize_fund_percent' => 2,
                    'odds' => 100,
                    'prize' => 50,
