...
final class AddGgWorldRedOrBluePage extends AbstractPageLottery
{
    protected const WP_DOMAIN_NAME_WITHOUT_PORT = ['lottopark.com'];
    protected const TITLES_AND_BODIES_PER_LANGUAGE = [
        'en' => [
            'play' => [
                'title' => 'GG World Red Or Blue',
                'body' => '',
            ],
        ],
    ];
    protected const GAME_NAME_SLUG = MiniGame::GG_WORLD_RED_OR_BLUE_SLUG;
