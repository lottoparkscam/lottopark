...
/**
 * Description of Forms_Wordpress_Payment_CreditCardSandbox
 *
 */
final class Forms_Wordpress_Payment_CreditCardSandbox extends Forms_Wordpress_Payment_Base implements Forms_Wordpress_Payment_Process
{
     ...
     * @var int
     */
    protected $payment_method = Helpers_Payment_Method::CREDIT_CARD_SANDBOX;
    ...
    protected function check_merchant_settings(): void
    {
        ...
        if (empty($this->payment_data['creditcardsandbox_url_to_redirect'])) {
            status_header(400);
            
            $this->log_error("Empty Credit Card Sandbox url to redirect.");
     ...
     * @return string|null
     */
    private function get_payment_url(): string
    {
        $this->get_payment_data();
        
        $payment_url = $this->payment_data['creditcardsandbox_url_to_redirect'];
