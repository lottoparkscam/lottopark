<form class="form-inline form-filter" method="get" action="/reports">
    <div class="form-group">
        <select name="filter[whitelabels_extended]" 
                id="filterWhitelabel" 
            ...
            <?php 
                foreach ($extended_list_of_whitelabels as $whitelabel_item):
            ?>
                    <option value="<?= $whitelabel_item['id']; ?>" <?= $whitelabel_item['selected']; ?>>
                        <?= $whitelabel_item['name']; ?>
                    </option>
            <?php 
                endforeach;
            ?>
