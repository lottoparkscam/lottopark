...
<div class="widget-6">
    ...
    <div class="widget-content" id="widget-content-<?=$widget_div_id;?>">
        ...
        <div class="widget-bottom">
            ...
            <div class="widget-time-left-title"><span
                        class ="calendar-icon"></span> <?= _("next jackpot"); ?></div>
            <div class="widget-time-left">
                <?=Lotto_View::get_formatted_date_for_widget($lotteries[0]['lottery']);?>
            </div>
        </div>
    </div>
</div>
