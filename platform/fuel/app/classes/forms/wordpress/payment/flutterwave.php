...
/**
 * Description of Forms_Wordpress_Payment_Flutterwave
 */
final class Forms_Wordpress_Payment_Flutterwave extends Forms_Main implements Forms_Wordpress_Payment_Process
{
    // TODO: this payment method was mady in one day - in extra short and stress time of emergency. Made by developer without any knowledge of payment system. This is the copy and paste of stripe. We should improve all logic of this class, and inherit it from base.php
    ...
    /**
     *
     * @return null|\Forms_Wordpress_Payment_Flutterwave
     */
    public function set_payment_data():? Forms_Wordpress_Payment_Flutterwave
    {
    ...
    public function set_model_whitelabel_payment_method(
        Model_Whitelabel_Payment_Method $model_whitelabel_payment_method = null
    ):? Forms_Wordpress_Payment_Flutterwave {
    ...
    public function get_whitelabel_from_whitelabel_payment_method():? array
    {
        if (empty($this->model_whitelabel_payment_method)) {
            ...
            $error_message = "No payment method of ID: " .
                Helpers_Payment_Method::FLUTTERWAVE;
     ...
     *
     * @param array $whitelabel
     * @return \Forms_Wordpress_Payment_Flutterwave
     */
     ...
     * @return \Forms_Wordpress_Payment_Flutterwave
     */
    public function set_user(array $user): Forms_Wordpress_Payment_Flutterwave
    {
        $this->user = $user;
    ...
    {
        if (empty($this->payment_data['flutterwave_public_key']) ||
            empty($this->payment_data['flutterwave_secret_key'])
        ) {
    ...
    public function process_form(): void
    {
        ...
        $this->request['PBFPubKey'] = $this->payment_data['flutterwave_public_key'];
        $this->request['redirect_url'] = $redirect_url;
        $this->request['payment_options'] = !empty($this->payment_data['flutterwave_payment_options']) ? $this->payment_data : "card";
        $this->request['network'] = !empty($this->payment_data['flutterwave_network']) ? $this->payment_data['flutterwave_network'] : "MTN,VODAFONE,TIGO";
    ...
    public function check_payment_result()
    {
        ...
        if (!$signature) {
            $error_message = "No HTTP_VERIF_HASH value set in SERVER array. " .
                "ID of payment method: " . Helpers_Payment_Method::FLUTTERWAVE;
            $this->log_error($error_message);
            exit($this->get_exit_text());
        }
        ...
        $local_signature = $this->payment_data['flutterwave_secret_webhook_key'];
...
//        $this->log("Flutterwave confirmation process begin.");
    ...
    private function check_merchant_settings(bool $is_notification = false): void
    {
        ...
        if (empty($payment_data['flutterwave_public_key']) ||
            empty($payment_data['flutterwave_secret_key']) ||
            empty($payment_data['flutterwave_secret_webhook_key'])
        ) {
