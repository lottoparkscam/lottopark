...
final class NorwegianKenoIntegration extends Seeder
{
    use \Without_Foreign_Key_Checks,
        \Adjusts_Next_Draw_Date;

    const LOTTERY_SLUG = Lottery::NORWEGIAN_KENO_SLUG;
    const LOTTERY_NAME = 'Norwegian Keno';
    const LOTTERY_SHORTNAME = 'NOK';
    const LOTTERY_ID = Helpers_Lottery::NORWEGIAN_KENO_ID;
    const LOTTERY_SOURCE_ID = 69;
    const LOTTERY_TYPE_ID = 63;
    const LOTTERY_PROVIDER_ID = 73;
    const COUNTRY_NAME = 'Norway';
    const COUNTRY_ISO = 'NO';
