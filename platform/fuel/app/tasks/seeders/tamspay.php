...
final class Tamspay extends Seeder
{
    ...
    {
        try {
            $this->facade = Container::getPaymentFacade('tamspay');
            ...
            echo sprintf('Unable to initialize %s, due errors. No data has been seeded.', __CLASS__);
            return;
        }
        parent::execute();
    }
