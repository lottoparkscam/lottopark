...
<div class="container-fluid">
	...
	<div class="col-md-10">
		<h2><?php echo _("Change password"); ?> <small><?php echo Security::htmlentities($user['email']); ?></small></h2>
		<p class="help-block"><?php echo _("You can change affiliate password here."); ?></p>
		<a href="/affs/list/view/<?php echo $user['token']; ?><?php echo Lotto_View::query_vars(); ?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-chevron-left"></span> <?php echo _("Back"); ?></a>
        <div class="container-fluid container-admin row">
            <div class="col-md-6">
				<form method="post" autocomplete="off" action="/affs/list/password/<?php echo $user['token']; ?><?php echo Lotto_View::query_vars(); ?>">
                    <?php 
                    ...
                    <div class="form-group<?php if (isset($errors['input.password'])): echo ' has-error'; endif; ?>">
                        ...
                        <div class="input-group">
                            <input type="password" required="required" autofocus 
                                   class="form-control clear" 
                                   id="inputPassword" 
                                   name="input[password]" 
                                   placeholder="<?php echo _("New password"); ?>">
