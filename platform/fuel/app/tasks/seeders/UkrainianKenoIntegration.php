...
final class UkrainianKenoIntegration extends Seeder
{
    use \Without_Foreign_Key_Checks,
        \Adjusts_Next_Draw_Date;

    const LOTTERY_SLUG = Lottery::UKRAINIAN_KENO_SLUG;
    const LOTTERY_NAME = 'Ukrainian Keno';
    const LOTTERY_SHORTNAME = 'UAK';
    const LOTTERY_ID = Helpers_Lottery::UKRAINIAN_KENO_ID;
    const LOTTERY_SOURCE_ID = 59;
    const LOTTERY_TYPE_ID = 53;
    const LOTTERY_PROVIDER_ID = 63;
    const COUNTRY_NAME = 'Ukraine';
    const COUNTRY_ISO = 'UA';
