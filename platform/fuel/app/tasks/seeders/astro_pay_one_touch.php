...
final class Astro_Pay_One_Touch extends Seeder
{
    ...
    {
        try {
            $this->facade = Container::getPaymentFacade('astro');
            ...
            echo 'Unable to initialize Astro seeder, due errors. No data has been seeded.';
            return;
        }
        parent::execute();
    }
