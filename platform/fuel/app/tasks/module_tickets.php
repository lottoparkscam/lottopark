...
final class Module_Tickets extends Task_Cli
{
    ...
    {
        $id_view = DB::insert('modules')->set(['name' => 'tickets-view'])->execute();
        $id_edit = DB::insert('modules')->set(['name' => 'tickets-edit'])->execute();
