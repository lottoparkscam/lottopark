...
<div class="container-fluid">
    ...
    <div class="col-md-10">
        <h2>Edit Mini-Game Promo Code</h2>
        <p class="help-block">You can edit a new mini-game promo code here.</p>
        ...
        <div class="container-fluid container-admin row">
            <div class="col-md-6">
                <form id="form-promocodes" method="post" action="/bonuses/freespins/<?= $promoCode['id'] . '/s/edit' . Lotto_View::query_vars(); ?>">
                    <?= Form::csrf() ?>
                    <?php
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                          ...
                          <script>
                            const promoFreeSpinValue = <?= $promoCode['free_spin_value'] ?>;
                            ...
                            document.getElementById('inputMiniGame').addEventListener('change', function() {
                              ...
                              const availableBets = availableBetsByGameId[selectedGameId]
                                ? JSON.parse(availableBetsByGameId[selectedGameId])
                                : [];
                              ...
                              availableBets.forEach(bet => {
                                ...
                                if (bet === promoFreeSpinValue) {
                                  option.selected = true;
                                }
                                betsSelect.appendChild(option);
                              });

                              document.getElementById('availableBetsContainer').style.display =
                                availableBets.length > 0 ? 'block' : 'none';
                            });
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="1" max="9999" class="form-control" id="inputFreeSpinCount" name="input[free_spin_count]"
                            ...
                            <div class="form-group">
                              ...
                              <input type="number" value="<?= Input::post('input.user_usage_limit', $promoCode['user_usage_limit'] ?? 1); ?>" max="99999999" class="form-control" id="inputUserUsageLimit" name="input[user_usage_limit]"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="inputDateStart" name="input[date_start]"
                                    value="<?= Input::post('input.date_start', date('m/d/Y', strtotime($promoCode['date_start'] ?? ''))); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="inputDateEnd" name="input[date_end]"
                                    value="<?= Input::post('input.date_end', date('m/d/Y', strtotime($promoCode['date_end'] ?? ''))); ?>"
                                    required placeholder="mm/dd/yyyy">
                            </div>
                            <div class="checkbox">
                                <label>
