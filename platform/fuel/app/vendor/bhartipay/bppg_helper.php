...
class BPPGModule
{
    ...
    /**
     * [$cust_first_name description]
     * @var [type]
     */
    private $cust_first_name;
    
    /**
     * [$cust_last_name description]
     * @var [type]
     */
    ...
    public function createTransactionRequest()
    {
        ...
        $post_variables = [
            ...
            "CUST_FIRST_NAME" => $this->_empty($this->cust_first_name),
            "CUST_LAST_NAME" => $this->_empty($this->cust_last_name),
