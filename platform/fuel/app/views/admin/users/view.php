            ...
            <div class="col-md-6 user-details">
                ...
                <span class="details-value">
                    <?php
                        ...
                        if ($user_data['show_user_balance']):
                            $balance_user = _("User currency") . ": " . $user_data['balance'];
                    ?>
                            <small>
                                <span class="glyphicon glyphicon-info-sign" 
                                      ...
                                      data-placement="top" 
                                      title="" 
                                      data-original-title="<?= $balance_user; ?>"></span>
                            </small>
                    <?php
                        endif;
                    ?>
                ...
                <span class="details-value">
                    <?php
                        ...
                        if ($user_data['show_user_balance']):
                            $bonus_balance_user = _("User currency") . ": " . $user_data['bonus_balance'];
                    ?>
                            <small>
                                <span class="glyphicon glyphicon-info-sign" 
                                      data-toggle="tooltip" 
                                      data-placement="top" 
                                      title="" 
                                      data-original-title="<?= $bonus_balance_user; ?>"></span>
                            </small>
                    <?php
                        endif;
                    ?>
                ...
                <span class="details-value">
                    <?= Security::htmlentities($user_data['last_ip']); ?>
                </span>
                <br>
                <span class="details-label">
