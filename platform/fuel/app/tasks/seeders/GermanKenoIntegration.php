...
final class GermanKenoIntegration extends Seeder
{
    use \Without_Foreign_Key_Checks,
        \Adjusts_Next_Draw_Date;

    const LOTTERY_SLUG = Lottery::GERMAN_KENO_SLUG;
    const LOTTERY_NAME = 'German Keno';
    const LOTTERY_SHORTNAME = 'DEK';
    const LOTTERY_ID = Helpers_Lottery::GERMAN_KENO_ID;
    const LOTTERY_SOURCE_ID = 58;
    const LOTTERY_TYPE_ID = 52;
    const LOTTERY_PROVIDER_ID = 62;
    const COUNTRY_NAME = 'Germany';
    const COUNTRY_ISO = 'DE';
