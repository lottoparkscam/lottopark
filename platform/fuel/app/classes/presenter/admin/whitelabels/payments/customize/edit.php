 ...
 */
final class Presenter_Admin_Whitelabels_Payments_Customize_Edit extends Presenter_Presenter
{
    ...
    {
        $this->begin_url = "/whitelabels/payments/" .
            $this->whitelabel['id'] . '/customize/' .
