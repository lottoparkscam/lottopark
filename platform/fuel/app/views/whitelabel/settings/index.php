...
<div class="container-fluid">
	...
	<div class="col-md-10">
		...
		<p class="help-block">
            <?= _("You can change site settings here."); ?>
        </p>
        ...
        <div class="container-fluid container-admin row">
            <div class="col-md-6">
                ...
                <form method="post" action="/settings">
                    ...
                    <?php
                    $register_company_class_error = "";
                    if (isset($errors['input.use_register_company'])) {
                        $register_company_class_error = ' has-error';
                    }
                    ?>

                    <div class="form-group<?= $register_company_class_error; ?>">
                        <label class="control-label" for="use_register_company">
                            <?= _("Show charity | company | legal entity field in registration form"); ?>:
                        </label>
                        <select required name="input[use_register_company]" id="use_register_company" class="form-control">
                            <?php
                            $types_table = [
                                _("No display") => Helpers_General::REGISTER_FIELD_NONE,
                                _("Optional") => Helpers_General::REGISTER_FIELD_OPTIONAL,
                            ...
                            foreach ($types_table as $text_to_show => $type_key):
                                $is_selected = '';
                                if ((Input::post("input.use_register_company") !== null && Input::post("input.use_register_company") == $type_key) ||
                                    (!empty($whitelabel['use_register_company']) &&
                                        in_array($whitelabel['use_register_company'], $types_table) &&
                                        $whitelabel['use_register_company'] == $type_key)
                                ) {
                                    $is_selected = ' selected="selected"';
                                }
                                ?>
