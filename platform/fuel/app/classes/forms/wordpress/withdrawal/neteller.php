...
/**
 * Description of Forms_Wordpress_Withdrawal_Neteller
 */
class Forms_Wordpress_Withdrawal_Neteller extends Forms_Main
{
    /**
     *
     * @var string
    ...
    public function validate_form(): Validation
    {
        ...
        $validation->add("withdrawal.add.neteller_email", _("Neteller E-mail"))
            ->add_rule('trim')
            ->add_rule('stripslashes')
            ->add_rule('required')
