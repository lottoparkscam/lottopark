...
final class Trustpayments extends Seeder
{
    ...
    {
        try {
            $this->facade = Container::getPaymentFacade('trustpayments');
            ...
            echo 'Unable to initialize Trustpayments seeder, due errors. No data has been seeded.';
            return;
        }
        parent::execute();
    }
