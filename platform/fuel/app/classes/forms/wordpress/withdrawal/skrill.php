...
/**
 * Description of Forms_Wordpress_Withdrawal_Skrill
 */
class Forms_Wordpress_Withdrawal_Skrill extends Forms_Main
{
    /**
     *
     * @var string
    ...
    public function validate_form(): Validation
    {
        ...
        $validation->add("withdrawal.add.skrill_email", _("Skrill E-mail"))
            ->add_rule('trim')
            ->add_rule('stripslashes')
            ->add_rule('required')
