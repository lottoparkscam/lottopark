...
final class FortuneFateRaffle extends Seeder
{
    use \Without_Foreign_Key_Checks;

    const RAFFLE_ID = 13;
    const RAFFLE_RULE_ID = 13;
    const RAFFLE_PROVIDER_ID = 13;
    const SLUG = Raffle::FORTUNE_FATE_RAFFLE_SLUG;
    const NAME = 'Fortune Fate Raffle';
    const COUNTRY_NAME = 'World';
    const COUNTRY_ISO = null;
    const TIMEZONE = 'UTC';
    const JACKPOT = 100000;
    const TICKET_PRICE = 50;
    const TICKET_COUNT = 3500;
    const CURRENCY = Currency::EUR;
    const MAX_LINES_PER_TICKET = 3500;
        ...
        return [
            ...
            'raffle_rule_tier' => [
                ...
                [
                    'raffle_rule_id' => self::RAFFLE_RULE_ID,
                    'currency_id' => self::CURRENCY,
                    'slug' => 'raffle-closed:2_20',
                    'matches' => json_encode([[2, 20]]),
                    'prize_type' => 0,
                    'prize_fund_percent' => 15.97,
                    'odds' => 184.21,
                    'prize' => 1000,
                    'is_main_prize' => 0,
                ],
