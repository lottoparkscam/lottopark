...
<div class="container-fluid">
    ...
    <div class="col-md-10">
        ...
        <p class="help-block">
            <?= _("You can edit multi-draw options here."); ?>
        </p>
                ...
                <form method="post" action="">
                    <div class="col-md-12 remove-sides-padding">
                        <div class="form-group col-md-6 remove-sides-padding">
                            ...
                            <input type="number" class="form-control" id="draws" name="draws" value="<?=(!empty($option->tickets)) ? $option->tickets : '1'; ?>" placeholder="<?php echo _("Enter number of draws"); ?>">
                        </div>
                    </div>
                    <div class="col-md-12 remove-sides-padding">
                        <div class="form-group col-md-6 remove-sides-padding">
                            <label for="campaign"><?php echo _("Discount"); ?>:</label>
                            <input type="number" min="0" max="99" step="0.25" value="<?=(!empty($option->discount)) ? $option->discount : '0.00'; ?>" class="form-control" id="discount" name="discount" placeholder="<?php echo _("Enter discount"); ?>">
                        </div>
                    </div>
                    <div class="col-md-12 remove-sides-padding">
                        <div class="form-group">
                            <button type="submit" name="submit" value="submit" class="btn btn-primary"><?php echo _("Edit option"); ?></button>
                        </div>
                </form>
            </div>
        </div>
