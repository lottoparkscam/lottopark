...
final class Module_Withdrawals extends Task_Cli
{
    ...
    {
        $id_view = DB::insert('modules')->set(['name' => 'withdrawals-view'])->execute();
        $id_edit = DB::insert('modules')->set(['name' => 'withdrawals-edit'])->execute();
