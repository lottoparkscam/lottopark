...
foreach ($filters_fields as $key => $value) {
    ...
    $filters[$value] = SanitizerHelper::sanitizeString($filter_temp ?? '');
}
?>
<form class="form-inline form-filter" method="get" action="<?= $link; ?>">
    ...
    <div class="form-group">
        <select name="filter[whitelabel]" 
            ...
            <?php 
                foreach ($whitelabels as $whitelabel_itm):
                    $selected = '';
                    if (Input::get("filter.whitelabel") == $whitelabel_itm['id']) {
                        $selected = ' selected="selected"';
                    }
            ?>
                    <option value="<?= $whitelabel_itm['id']; ?>" <?= $selected; ?>>
                        <?= $whitelabel_itm['name']; ?>
                    </option>
            <?php 
                endforeach;
