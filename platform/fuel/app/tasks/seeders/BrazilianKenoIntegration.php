...
final class BrazilianKenoIntegration extends Seeder
{
    use \Without_Foreign_Key_Checks,
        \Adjusts_Next_Draw_Date;

    const LOTTERY_SLUG = Lottery::BRAZILIAN_KENO_SLUG;
    const LOTTERY_NAME = 'Brazilian Keno';
    const LOTTERY_SHORTNAME = 'BRK';
    const LOTTERY_ID = Helpers_Lottery::BRAZILIAN_KENO_ID;
    const LOTTERY_SOURCE_ID = 65;
    const LOTTERY_TYPE_ID = 59;
    const LOTTERY_PROVIDER_ID = 69;
    const COUNTRY_NAME = 'Brazil';
    const COUNTRY_ISO = 'BR';
    ...
    const DRAW_BREAK_START = '00:56';
    const DRAW_BREAK_END = '07:04';
