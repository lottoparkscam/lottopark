...
<div class="container-fluid">
    ...
    <div class="col-md-10">
        ...
        <p class="help-block">
            <?= _("You can edit your promo codes bonus here."); ?>
        </p>
        ...
        <div class="container-fluid container-admin row">
            <div class="col-md-6">
                <form id="form-promocodes" method="post" action="/bonuses/promocodes/<?= $campaign['token']; ?>/s/edit<?= Lotto_View::query_vars(); ?>">
                    <?php
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?php
                                    ...
                                    if (Input::post("input.purchase") === "1" || $campaign['type'] === "0" || $campaign['type'] === "3" || $campaign['type'] === "4" || $campaign['type'] === "6") {
                                        $purchase_checked = true;
                                    }
                                    if (Input::post("input.deposit") === "1" || $campaign['type'] === "1" || $campaign['type'] === "3" || $campaign['type'] === "5" || $campaign['type'] === "6") {
                                        $deposit_checked = true;
                                    }
                                    if (Input::post("input.register") === "1" || $campaign['type'] === "2" || $campaign['type'] === "4" || $campaign['type'] === "5" || $campaign['type'] === "6") {
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $codes_num_value_t = $codes_count > 1 ? $codes_count : "";
                                    ...
                                    $codes_user_num_value_t = $campaign['max_codes_user'] !== null ? $campaign['max_codes_user'] : '';
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?php
                                    ...
                                    if ($campaign['bonus_type'] === "1" && (int)Input::post("input.deposit") === 0) {
                                        $ticket_checked = false;
                                        $discount_checked = true;
                                        $bonus_money_checked = false;
                                    } elseif ($campaign['bonus_type'] === "2") {
                                        $ticket_checked = false;
                                        $discount_checked = false;
                                    ...
                                    <select name="input[lottery]" id="inputPromoCodeLottery" class="form-control">
                                        ...
                                        <?php
                                            foreach ($lotteries as $lottery):
                                                $is_selected = '';
                                                if (($campaign['lottery_id'] !== null &&
                                                    $campaign['lottery_id'] == $lottery['id'])
                                                ) {
                                ...
                                <?php
                                    ...
                                    if ($campaign['discount_type'] === "1" || $campaign['bonus_balance_type'] === "1") {
                                        $percent_checked = false;
                                        $amount_checked = true;
                                    }
                                    $amount_value_t = $campaign['discount_amount'] !== null ? $campaign['discount_amount'] : ($campaign['bonus_balance_amount'] !== null ? $campaign['bonus_balance_amount'] : '');
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <?php
                                if (!$used):
                                $users_num_value_t = $campaign['max_users_per_code'] !== null ? $campaign['max_users_per_code'] : '';
                            ...
                            <?php
                                $users_limit_value_t = $campaign['max_users'] !== null ? $campaign['max_users'] : '';
                            ...
                            <?php
                                ...
                                $start_date_value_t = $campaign['date_start'] !== null ? date('m/d/Y', strtotime($campaign['date_start'])) : '';
                            ...
                            <?php
                                $end_date_value_t = $campaign['date_end'] !== null ? date('m/d/Y', strtotime($campaign['date_end'])) : '';
