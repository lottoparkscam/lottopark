...
class XmlToArray
{
     ...
     */
    private static $_htmlEntityExceptions = [
        '&euro;' => '€',
    ];
    ...
    public function __construct($input, $maxDepth = 20)
    {
        ...
        xml_set_character_data_handler($XMLParser, [$this, '_contents']);
        xml_set_default_handler($XMLParser, [$this, '_default']);
        xml_set_element_handler($XMLParser, [$this, '_start'], [$this, '_end']);
