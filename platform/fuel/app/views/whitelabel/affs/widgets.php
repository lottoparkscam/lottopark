...
<div class="container-fluid">
    ...
    <div class="col-md-10 banners-generator widgets-generator">
        <div class="container-fluid container-admin row">
            <div class="col-md-12">
                <h2><?= _("Widgets"); ?></h2>
                <p class="help-block"><?= _("Here you can get your widget code."); ?></p>
            </div>
            <div class="col-md-6">
                <?php
                ...
                <form method="post"
                    ...
                    <div class="form-group">
                        ...
                        <select name="widget_option"
                            ...
                            foreach ($types as $key => $type):
                                $type_selected = '';
                                if (Input::post("widget_option") == $key) {
                    ...
                    <div class="form-group">
                        ...
                        <select name="widget_size"
                            ...
                            <option value="custom"
                                <?= Input::post("widget_size") == 'custom' ? ' selected="selected"' : ''; ?>>
                                Custom width
                            </option>
                        </select>
                    </div>
                            ...
                            <div class="form-group widget-lotteries collapse"
                                ...
                                <select name="lottery<?= $i; ?>"
                                    ...
                                    foreach ($lotteries as $key => $lottery):
                                        ...
                                        ?>
                                        <option value="<?= $lottery['slug']; ?>"
                                            <?= Input::post("lottery" . $i) == $lottery['slug'] ? ' selected="selected"' : ''; ?>>
                        ...
                        <select name="language"
                            ...
                            foreach ($langs as $lang):
                                ...
                                <option value="<?= $lang['code']; ?>"
                                    <?php if ((Input::post("language") !== null && Input::post("language") == $lang['code']) || (Input::post("language") === null && $whitelabel['language_id'] == $lang['id'])): echo ' selected="selected"'; endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block"><?= _("The advertising or marketing medium, for example: cpc, banner, email newsletter."); ?></p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block"><?= _("The individual campaign name, slogan, promo code, etc."); ?></p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block"><?= _("Used to differentiate similar content, or links within the same ad. For example, if you have two call-to-action links within the same email message, you can use <em>content</em> and set different values for each so you can tell which version is more effective."); ?></p>
                    </div>
