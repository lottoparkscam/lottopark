...
final class MysticFateRaffle extends Seeder
{
    use \Without_Foreign_Key_Checks;

    const RAFFLE_ID = 14;
    const RAFFLE_RULE_ID = 14;
    const RAFFLE_PROVIDER_ID = 14;
    const SLUG = Raffle::MYSTIC_FATE_RAFFLE_SLUG;
    const NAME = 'Mystic Fate Raffle';
    ...
    const MAX_LINES_PER_TICKET = 1000;
        ...
        return [
            ...
            'raffle_rule_tier' => [
                ...
                [
                    'raffle_rule_id' => self::RAFFLE_RULE_ID,
                    'currency_id' => self::CURRENCY,
                    'slug' => 'raffle-closed:2_5',
                    'matches' => json_encode([[2, 5]]),
                    'prize_type' => 0,
                    'prize_fund_percent' => 11.76,
                    'odds' => 250,
                    'prize' => 500,
                    'is_main_prize' => 0,
                ],
