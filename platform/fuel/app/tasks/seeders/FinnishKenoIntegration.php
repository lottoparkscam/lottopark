...
final class FinnishKenoIntegration extends Seeder
{
    use \Without_Foreign_Key_Checks,
        \Adjusts_Next_Draw_Date;

    const SLUG = Lottery::FINNISH_KENO_SLUG;
    const LOTTERY_ID = Helpers_Lottery::FINNISH_KENO_ID;
    const LOTTERY_SOURCE_ID = 51;
    const LOTTERY_TYPE_ID = 45;
    const LOTTERY_PROVIDER_ID = 55;
    const DRAW_DAYS = [1,2,3,4,5,6,7];
    const DRAW_TIMES = ['15:00', '20:58', '23:00'];
    ...
    protected function rowsStaging(): array
    {
        ...
        return [
            ...
            'lottery_type' => [
                [self::LOTTERY_TYPE_ID, self::LOTTERY_ID, 0.16, 20, 0, 70, 0, 0, 0],
            ],
            'lottery_type_data' => [
